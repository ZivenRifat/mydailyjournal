...
<body>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="admin.php?page=user">User Profile</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <!-- content end -->
    <!-- footer begin -->
    <footer id="footer" class="text-center p-3 bg-danger-subtle">
        <div class="bg-danger-subtle">
            <a href="https://www.instagram.com/zivenrifat/"><i class="bi bi-instagram h2 p-2"></i></a>
            </a>
            <a href="https://wa.me/+628386125750"><i class="bi bi-whatsapp h2 p-2"></i></a>
        </div>
        <div>Ziven Rifat &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
